...
{*Esta area es para editar la información de Footer*}
				<li class="last_item">{l s='[1]Tu supermercado online [/1]' mod='blockcms' sprintf=['Yalobox™'] tags=['<a class="_blank" href="http://www.yalobox.com">']}</li>
