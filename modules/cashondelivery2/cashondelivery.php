...
class CashOnDelivery2 extends PaymentModule
{
	public function __construct()
	{
		$this->name = 'cashondelivery2';
		$this->tab = 'payments_gateways';
		$this->version = '0.7.5';
		$this->author = 'Juan Pérez"';
		...
		$this->displayName = $this->l('Pago con Dinero Electronico');
		$this->description = $this->l('Valido en todo el Ecuador paga tus compras con tu celular');
	...
	public function hookDisplayPaymentEU($params)
	{
		...
		return array(
			'cta_text' => $this->l('Pago con Dinero Electronico'),
