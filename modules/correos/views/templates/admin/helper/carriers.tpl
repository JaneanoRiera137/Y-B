...
<div class="panel-heading">{l s='Available carriers' mod='correos'}</div>
   <div class="panel-body">
    ...
    <tbody>
      ...
      <tr>
        <td>
        {if file_exists($path_module|cat:'views/img/logo_'|cat:$correos_carrier.code|cat:'.jpg'|lower)}
        <img class="imgm img-thumbnail" style="vertical-align:middle" src="{$path_logo|escape:'htmlall':'UTF-8'}logo_{$correos_carrier.code|lower|escape:'htmlall':'UTF-8'}.jpg" alt="" title="" width="128" height="40" /></td>
        {/if}
             ...
             {else}
               ...
               {foreach from=$carriers item=carrier}
                  ...
                  {$botton_placed=1}
                   ...
                   href="{$carrier_url|escape:'htmlall':'UTF-8'}&id_carrier={$carrier.id_carrier|escape:'htmlall':'UTF-8'}">
  ...
  <form class="form clearfix " enctype="multipart/form-data" method="post">
      <div class="form-group">
         <label class="control-label">{l s='Enable timetable selection for "Paq 48 domicilio"' mod='correos'}</label>
