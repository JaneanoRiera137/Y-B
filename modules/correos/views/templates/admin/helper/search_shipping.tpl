      ...
      <form class="form clearfix" id="correos_orders" enctype="multipart/form-data" method="post">
        <table class="table order">
               ...
               <th class="text-right">
                  <div class="date_range row">
                     <div class="input-group fixed-width-md">
                        <input id="local_orderFilter_dateFrom" class="filter datepicker date-input form-control" type="text" placeholder="Desde" 
         ...
         {foreach from=$orders item=order}
            <tr>
               <td class="row-selector"><input type="checkbox" name="id_order[{$order.id_order|escape:'htmlall':'UTF-8'}]" value="{$order.shipment_code|escape:'htmlall':'UTF-8'}"></td>
   ...
   <div class="row">
      <div class="col-lg-6">
		...
		<div class="pagination">
			...
			<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
				{$pagination.order_rows|escape:'htmlall':'UTF-8'}
			...
			/ {$pagination.total_rows|escape:'htmlall':'UTF-8'} {l s='results' mod='correos'}
			<input id="order_rows" name="order_rows" value="{$pagination.order_rows|escape:'htmlall':'UTF-8'}" type="hidden">
		</div>
      ...
      <ul class="pagination pull-right">
						...
						<li {if $pagination.page <= 1}class="disabled"{/if}>
							<a href="javascript:void(0);" class="pagination-link" data-page="{$pagination.page|escape:'htmlall':'UTF-8' - 1}">
								<i class="icon-angle-left"></i>
							</a>
						</li>
						{assign p 0}
						{while $p++ < $pagination.total_pages}
							{if $p < $pagination.page-2}
								<li class="disabled">
									<a href="javascript:void(0);">&hellip;</a>
								</li>
								{assign p $pagination.page-3}
							{else if $p > $pagination.page+2}
								<li class="disabled">
									<a href="javascript:void(0);">&hellip;</a>
								</li>
								{assign p $pagination.total_pages}
							{else}
							...
							{/if}
						{/while}
						<li {if $pagination.page >= $pagination.total_pages}class="disabled"{/if}>
							<a href="javascript:void(0);" class="pagination-link" data-page="{$pagination.page|escape:'htmlall':'UTF-8' + 1}">
								<i class="icon-angle-right"></i>
							</a>
						</li>
						<li {if $pagination.page >= $pagination.total_pages}class="disabled"{/if}>
							<a href="javascript:void(0);" class="pagination-link" data-page="{$pagination.total_pages|escape:'htmlall':'UTF-8'}">
        ...
        <div class="modal-body">
         ...
         <div class="form-horizontal">
            ...
            <div class="form-group">
               ...
               <label for="collection_req_name" class="control-label">
                   {l s='Name and surname' mod='correos'}
               </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_nombre.value|escape:'htmlall':'UTF-8'} {$sender_form.options.sender_apellidos.value|escape:'htmlall':'UTF-8'}" id="collection_req_name" name="collection_req_name" class="form-control" autocomplete="off">
               </div>
            </div>
            
            <div class="form-group">
               <div class="col-xs-4 text-right">
               <label for="collection_req_address" class="control-label">
                   {l s='Address' mod='correos'}
               </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_direccion.value|escape:'htmlall':'UTF-8'}" id="collection_req_address" name="collection_req_address" class="form-control" autocomplete="off">
               </div>
            </div>
            ...
            <div class="form-group">
               <div class="col-xs-4 text-right">
                  <label for="collection_req_city" class="control-label">
                     {l s='City' mod='correos'}
                  </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_localidad.value|escape:'htmlall':'UTF-8'}" id="collection_req_city" name="collection_req_city" class="form-control" autocomplete="off">
               </div>
            </div>
            
            <div class="form-group">
               <div class="col-xs-4 text-right">
                  <label for="collection_req_postalcode" class="control-label">
                  {l s='Postal Code' mod='correos'}
                  </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_cp.value|escape:'htmlall':'UTF-8'}" id="collection_req_postalcode" name="collection_req_postalcode" class="form-control" autocomplete="off">
               </div>   
            </div>
            
            <div class="form-group">
               <div class="col-xs-4 text-right">
                  <label for="collection_req_state" class="control-label">
                     {l s='Province' mod='correos'}
                  </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_provincia.value|escape:'htmlall':'UTF-8'}" id="collection_req_state" name="collection_req_state" class="form-control" autocomplete="off">
               </div>
            </div>
            <div class="form-group">
               <div class="col-xs-4 text-right">
               ...
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_tel_fijo.value|escape:'htmlall':'UTF-8'}" id="collection_req_phone" name="collection_req_phone" class="form-control" autocomplete="off">
               </div>
            </div>
            
            <div class="form-group">
               <div class="col-xs-4 text-right">
                  <label for="collection_req_mobile_phone" class="control-label">
                     {l s='Mobile phone' mod='correos'}
                  </label>
               </div>
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_movil.value|escape:'htmlall':'UTF-8'}" id="collection_req_mobile_phone" name="collection_req_mobile_phone" class="form-control" autocomplete="off">
               </div>
            </div>
            ...
            <div class="form-group">
               ...
               <div class="col-xs-8">
                  <input type="text" value="{$sender_form.options.sender_email.value|escape:'htmlall':'UTF-8'}" id="collection_req_email_cc" name="collection_req_email_cc" class="form-control" autocomplete="off">
               </div>
            </div> 
         </div>
         <div class="form-group pull-left col-xs-4">
            ...
            <input type="text" value="" id="collection_time" name="collection_req_time" class="form-control" placeholder="{l s='eg, 10:00-12:00' mod='correos'}" autocomplete="off">
         </div> 
         <div class="form-group pull-left col-xs-4">
            <label class="control-label">
               {l s='Date of collection' mod='correos'}  
            </label>
            <input type="text" value="" id="collection_date" name="collection_req_date" class="datepicker date-input form-control" autocomplete="off">
         ...
         <div class="form-group pull-left col-xs-4">
            ...
            <input type="text" value="1" id="collection_pieces" name="collection_req_pieces" class="form-control" autocomplete="off">
         </div>
         <div class="form-group">
            <label class="control-label">
         ...
         <hr>
         <button class="btn btn-primary pull-right has-action btn-save-general" name="form-request_collection" type="submit">
