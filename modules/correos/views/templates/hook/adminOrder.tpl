      ...
      <div class="tab-content panel">
         <!-- Tab labels -->
            ...
            <form id="correos_form_label" method="post">
               <div class="well form-horizontal hidden-print">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-6">
                              ...
                              {foreach from=$customs_categories key='id' item='name'}
                                 <option value="{$id|escape:'htmlall':'UTF-8'}">{$name|escape:'htmlall':'UTF-8'}</option>
                              {/foreach}
                              </select>
                           </div>
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group col-lg-2">
                           <input type="text" id="correos_package_weight" name="correos_package_weight" value="{$weight|escape:'htmlall':'UTF-8'}" class="form-control required" title="{l s='Weight' mod='correos'} (Kg)"/>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group col-lg-2">
                           <input type="text" id="correos_package_insurance"  name="correos_package_insurance" value="0" title="{l s='All-risks insurance' mod='correos'}" class="form-control "/>
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-lg-7">
                           <input type="text" id="correos_package_observations"  name="correos_package_observations" value="" maxlength="45" title="{l s='All-risks insurance' mod='correos'}" class="form-control" />
                           <p class="help-block">
               ...
               <div id="correos_package_info">
                  <input type="hidden" class="correos_sender_hidden" name="correos_sender_hidden" value="sender_1" />
                  <input type="hidden" class="correos_package_weight_hidden" name="correos_package_weight_hidden" value="{$weight|escape:'htmlall':'UTF-8'}" />
                  <input type="hidden" class="correos_package_long_hidden" name="correos_package_long_hidden" 
                  {if $order_prducts|@count eq 1}
								{assign var=first_prduct_key value = $order_prducts|@key}
						   ...
						   {/if}
                   />
                  <input type="hidden" class="correos_package_width_hidden" name="correos_package_width_hidden"  {if $order_prducts|@count eq 1}
								{assign var=first_prduct_key value = $order_prducts|@key}
						   ...
						   {/if}
                     />
                  <input type="hidden" class="correos_package_height_hidden" name="correos_package_height_hidden" {if $order_prducts|@count eq 1}
								{assign var=first_prduct_key value = $order_prducts|@key}
						   ...
						   {/if}
                     />
                  <input type="hidden" class="correos_package_insurance_hidden" name="correos_package_insurance_hidden" value="0" />
				  <input type="hidden" class="correos_package_observations_hidden" name="correos_package_observations_hidden" />
                  <input type="hidden" class="goods_type_hidden" name="goods_type_hidden" value="24" />
   ...
   var noPaqsFound = "{l s='We are sorry, no results was found' mod='correos'}";
	$(document).ready(function()
	{
               ...
               $('#preregisterAgain').live('click',function(event) {
					...
					$("select[name=id_order_state]").parent().append($("#correos_package_info").clone());
				{literal}	
					$("#correos_package_weight").keyup(function () { 
                  calcutaleBult();
                  $(".correos_package_weight_hidden").val($(this).val()); 
                  });
					$("#correos_package_long").keyup(function () { 
                  calcutaleBult();
                  $(".correos_package_long_hidden").val($(this).val()); });
					$("#correos_package_width").keyup(function () { 
                  calcutaleBult();
                  $(".correos_package_width_hidden").val($(this).val()); 
                  });
					$("#correos_package_height").keyup(function () { 
                  calcutaleBult();
                  $(".correos_package_height_hidden").val($(this).val()); 
                  });
               $("#correos_package_insurance").keyup(function () {
                  $(".correos_package_insurance_hidden").val($(this).val()); 
                  });
				$("#correos_package_observations").keyup(function () {
                  $(".correos_package_observations_hidden").val($(this).val()); 
                  });
               
				{/literal}
				{if $senders_select|@count gt 0}
					//$("#id_order_state").parent().append($("#correos_sender_hidden"));
					$("#correos_sender").change(function () {
						$(".correos_sender_hidden").val($(this).val());								  
					});
				{/if}
				{if $require_customs}
						$("#goods_type").change(function () { 
							$(".goods_type_hidden").val($(this).val());								  
						});
						$("#customs_firstproductvalue").change(function () { $(".customs_firstproductvalue_hidden").val($(this).val()); });
				{/if}
				...
				function GetcorreosPoint()
				{
                    ...
                    var _data = {
						...
						id_cart : {$id_cart|escape:'htmlall':'UTF-8'},
                        id_carrier : {$id_carrier|escape:'htmlall':'UTF-8'},
            ...
            function GetPaqsFavourites()
            {
               ...
               $("#homepaq_search_fail").hide();
					...
					$.ajax(
					{
                        ...
                        HomePaqs = result.correospaqs;
                        
                        $(".homepaq_token").val(result.token);
                        
                        
                        if(HomePaqs.length > 0){
                           $(".homepaqs").val(JSON.stringify(result.correospaqs));
            ...
            function correosPaqInfo()
				{
					...
					jQuery.each(HomePaqs, function() {
						 if (this.code == code)
						 {
							...
							$('#selected_paq').html(this.alias + " - " + this.streetType + " " + this.address + ", " + this.city);
